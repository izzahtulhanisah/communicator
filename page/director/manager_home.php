    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <a href= "../../page/director/manager_view_project_list.php">
        		...
        		<a href= "../../page/director/manager_view_employee.php">
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="card">
                        <div class="header bg-blue-grey">
                                <h2><center><strong>
                                HIGHLIGHTS
								<a href = "new_highlight.php" class="btn btn-info pull-right"><span class='glyphicon glyphicon-pencil' aria-hidden='true'></span></a>
                        ...
                        <div class="body">
                            <div class="table-responsive">
                                <table class="table table-hover dashboard-task-infos">
									...
									$sql = "SELECT * from highlight ORDER BY id_highlight DESC";
