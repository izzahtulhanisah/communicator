        ...
        <div class="container-fluid">
			...
			<div class="body">
				...
				<ol class="breadcrumb">
					...
					<li>
						<a href="../../page/director/manager_view_sv_task.php">
						...
						<div class="table-responsive">
                            <table class="table table-striped table-bordered table-hover">
								...
								include "database.php";
									...
									$sql  = "SELECT task2.task_id,task2.task_title, task2.task_status, task2.task_created, task2.task_due_date, task2.task_description,task2.task_comment,
											project.project_id, project.project_name,task2.sv_id, supervisor.sv_id,supervisor.sv_name,
											...
											AND task2.sv_id='$sv_id'

											ORDER BY project.project_name, supervisor.sv_id";
														...
														<form method="post" class="form-horizontal" role="form">
															...
															<div class="row clearfix">
																...
																<div class="col-lg-2 col-md-2 col-sm-4 col-xs-5 form-control-label">
																		<label for="project_name">Assignment</label>
																	</div>
								...
								echo "<script>alert('*Solutions Updated*');window.location.href='javascript:history.back(-1);'</script>";
										} else {
