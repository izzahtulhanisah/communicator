...
include 'database.php';
					  ...
					  <center><div class="panel panel-success" style="width: 500px">
					    ...
					    <div class="panel-body">
								<form method="post" action="">
									...
									<input class="form-control" type="hidden" name="manager_id" value="<?php echo $manager_id; ?>"><br>
									<input class="btn btn-success pull-right" type="submit" name="forgot2" value="Submit">
									<button class="btn btn-bg-grey pull-left" type="button" onclick="window.location.href='director_forgot.php'">Back</button>
								</form>
							</div>
						</div></center>
					</div>
					  ...
					  <center><div class="panel panel-success" style="width: 500px">
					    ...
					    <div class="panel-body">
								<form method="post" action="">
									...
									<input class="form-control" type="hidden" name="manager_id" value="<?php echo $manager_id; ?>">
									<br>
		...
		elseif(isset($_POST['reset'])){
			...
			if($password1 === $password2){
				...
				$query = "UPDATE manager SET manager_password='$password1' WHERE  manager_id='$manager_id'  ";
					    ...
					    <div class="panel-heading">Reset Password</div>
					    	<div class="panel-body">
									<form method="post" action="">
										...
										<input class="form-control" type="text" name="manager_id"><br>
