                                ...
                                <tbody>
									...
									if(isset($_POST['profile_manager'])){
										...
										if ($conn->query($sql) === TRUE) {
											echo '<script>window.location.href="sv_view_staff.php"</script>';
										} else {
									...
									if(isset($_POST['update_manager'])){
										...
										$sql = "UPDATE employee SET
											...
											WHERE id='$edit_id' ";
										if ($conn->query($sql) === TRUE) {
											echo '<script>alert("Succesfully change password for '.$employee_name.'");window.location.href="sv_view_staff.php"</script>';
										} else {
											echo "Error updating record: " . $conn->error;
										}
									}
