        ...
        <div class="container-fluid">
			...
			<div class="body">
                <ol class="breadcrumb">
                    ...
                    <li>
						<a href="../../page/supervisor/sv_view_profile.php">
						...
						?>
                            <form id="form_validation" action="update_sv_profile.php" method="post">
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" id="sv_name" class="form-control" name="sv_name" value="<?php echo $sv_name; ?>" placeholder="Enter your name" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="email" id="sv_email" class="form-control" name="sv_email" value="<?php echo $sv_email; ?>" placeholder="Enter your email address" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" id="sv_department" class="form-control" name="sv_department" value="<?php echo $sv_department; ?>" placeholder="Enter your department">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" id="sv_phoneno" class="form-control" name="sv_phoneno" value="<?php echo $sv_phoneno; ?>" placeholder="Enter your phone number" required>
                                    </div>
                                </div>
								<label for="sv_address">Address</label>
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" id="sv_address" class="form-control" name="sv_address" value="<?php echo $sv_address; ?>" placeholder="Enter your address" required>
                                    </div>
                                </div>
