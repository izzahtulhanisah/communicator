    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                    ...
                    <div class="info-box bg-cyan hover-expand-effect">
                        ...
                        <div class="content">
							...
							<?php
								...
								$sql2 = "SELECT count(task_id) AS total FROM task2 WHERE sv_id = '$abc'";
				...
				<a href= "../../page/supervisor/sv_inprogress.php">
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        ...
                        <div class="content">
							...
							<?php
								...
								$sql2 = "SELECT count(task_id) AS total
										 FROM task2
										 WHERE task_status = 'In Progress' AND sv_id = '$abc'";
								$result2 = mysqli_query($conn,$sql2);
								$values2=mysqli_fetch_assoc($result2);
								$num_rows=$values2['total'];
								echo '<div class="huge"> '.$num_rows.'</div>'
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="card">
                        <div class="header bg-blue-grey">
                                <h2><center><strong>
                                HIGHLIGHTS
								<a href = "sv_new_highlight.php" class="btn btn-info pull-right"><span class='glyphicon glyphicon-pencil' aria-hidden='true'></span></a>
