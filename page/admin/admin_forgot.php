...
include 'database.php';
					  ...
					  <center><div class="panel panel-success" style="width: 500px">
					    ...
					    <div class="panel-body">
								<form method="post" action="">
									...
									<input class="form-control" type="hidden" name="admin_id" value="<?php echo $admin_id; ?>"><br>
									<input class="btn btn-success pull-right" type="submit" name="forgot2" value="Submit">
									<button class="btn btn-bg-grey pull-left" type="button" onclick="window.location.href='admin_forgot.php'">Back</button>
								</form>
							</div>
						</div></center>
					</div>
					  ...
					  <center><div class="panel panel-success" style="width: 500px">
					    ...
					    <div class="panel-body">
								<form method="post" action="">
									...
									<input class="form-control" type="hidden" name="admin_id" value="<?php echo $admin_id; ?>">
									<br>
		...
		elseif(isset($_POST['reset'])){
			...
			if($password1 === $password2){
				...
				$query = "UPDATE admin SET admin_password='$password1' WHERE  admin_id='$admin_id'  ";
					    ...
					    <div class="panel-heading">Reset Password</div>
					    	<div class="panel-body">
									<form method="post" action="">
										...
										<input class="form-control" type="text" name="admin_id"><br>
