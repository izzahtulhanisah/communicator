        ...
        <div class="container-fluid">
		 ...
		 <div class="body">
			...
			<ol class="breadcrumb">
				...
				<li class="active">
					<i class="material-icons">group_add</i> Register New Manager
				</li>
			</ol>
                        ...
                        <div class="body">
                            <form action = "reg_manager.php" method="post">
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" id="sv_id" name="sv_id" class="form-control" placeholder="Enter Manager ID">
                                    </div>
                                </div>
                                <label for="password">Password</label>
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="password" id="sv_password" name="sv_password" class="form-control" placeholder="Enter Manager Password">
                                    </div>
                                </div>
