...
<head>
    ...
    <title>FlexiCOMM| Director List</title>
    <!-- Favicon-->
        ...
        <div class="container-fluid">
		 ...
		 <div class="body">
                            ...
                            <ol class="breadcrumb">
                                ...
                                <li class="active">
                                    <i class="material-icons">group</i> Director List
                                </li>
                            </ol>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header clearfix bg-blue-grey">
                            <h2><center><strong>DIRECTOR LIST</button></strong></center></h2>
                        </div>
                        <div class="body">
											...
											<div class="modal-dialog" role="document">
												<div class="modal-content">
													<div class="modal-header">
														<h4 class="modal-title" id="defaultModalLabel"><center>DIRECTOR PROFILE</center></h4>
													</div>
									 ...
									 <!-- Update Director Password -->
										<div class="modal fade" id="defaultModal<?php echo $id; ?>" tabindex="-1" role="dialog">
											<div class="modal-dialog" role="document">
												<div class="modal-content">
													<div class="modal-header">
														<h4 class="modal-title" id="defaultModalLabel"><center>EDIT DIRECTOR PASSWORD</center></h4>
													</div>
													<div class="modal-body">
														...
														<form method="post" class="form-horizontal" role="form">
															...
															<input type="hidden" id="manager_name" name="manager_name" value="<?php echo $manager_name; ?>">
													...
													<div class="modal-body">
														...
														<form method="post" class="form-horizontal" role="form">
															...
															<div class="alert bg-red">
																...
																<label>ID : </label> <?php echo $manager_id; ?><br>
																<label>Name : </label> <?php echo $manager_name; ?>
																</strong></p>
