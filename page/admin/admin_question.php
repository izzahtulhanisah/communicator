    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="../../page/staff/admin_home.php">Flexi<b>COMMUNICATOR</b></a>
            </div>
                     ...
                     <li class="dropdown">
                        <a href="javascript:void(0);" class="dropdown-toggle" data-toggle="dropdown" role="button">
                            <i class="material-icons">notifications</i>
							 ...
							 <?php
								...
								$sql  = '
										SELECT admin_id,task_status, COUNT(*)
										 AS count
										 FROM task
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="body">
                                <ul class="menu">
                                    <li>
                                        <a href="../../page/staff/admin_open_delay_task.php">
                                            ...
                                            <div class="menu-info">
													...
													<?php
														...
														$t = "SELECT admin_id,task_status, COUNT(*)
															 AS count
															 FROM task
															 WHERE task_status='delayed'
															 AND admin_id = '".$_SESSION['admin_id']."'
        ...
        <aside id="leftsidebar" class="sidebar">
                ...
                <div class="info-container">
                    ...
                    <div class="btn-group user-helper-dropdown">
                        ...
                        <ul class="dropdown-menu pull-right">
							...
							<li role="seperator" class="divider"></li>
                            <li><a href="admin_question.php"><i class="material-icons">verified_user</i>Edit Answers</a></li>
                            <li role="seperator" class="divider"></li>
            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li>
                        <a href="../../page/staff/admin_home.php">
					...
					<li class="active">
						...
						<ul class="ml-menu">
							<li>
                                <a href="../../page/staff/admin_view_profile.php">Your Profile</a>
                            </li>
							<li class="active">
                                <a href="../../page/staff/admin_question.php">Edit Secret Answers</a>
                            </li>
                        </ul>
                    </li>

					<li>
                        <a href="../../page/staff/admin_view_project_list.php">
                   ...
                   <li>
                        <a href="../../page/staff/admin_open_task.php">
                            <i class="material-icons">date_range</i>
                            <span>Tasks</span>
                        </a>
                    </li>
